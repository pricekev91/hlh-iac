...
INVENTORY="${ANSIBLE_DIR}/inventories/hlh-ai-engine-egpu-vulkan.yml"
PLAYBOOK="${ANSIBLE_DIR}/playbooks/hlh-ai-engine-egpu-vulkan.yml"
...
usage() {
    cat <<'EOF'
Usage:
  ./configure-hlh-ai-engine-egpu-vulkan.sh [--host <ip>] [--offline]
