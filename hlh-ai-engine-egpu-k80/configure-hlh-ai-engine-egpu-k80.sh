...
INVENTORY="${ANSIBLE_DIR}/inventories/hlh-ai-engine-egpu-k80.yml"
PLAYBOOK="${ANSIBLE_DIR}/playbooks/hlh-ai-engine-egpu-k80.yml"
...
usage() {
    cat <<'EOF'
Usage:
  ./configure-hlh-ai-engine-egpu-k80.sh [--host <ip>] [--offline]

Options:
  --host <ip>  Override target host from inventory (default 192.168.1.31).
