...
# Version: 1.0.0-k80-vulkan
# Description: Bootstrap llama.cpp AI engine on Ubuntu 24.04 LXC with Vulkan (K80 dual GK210 test) via OCuLink
# Target GPU: NVIDIA Tesla K80 2x GK210GL (12GB per chip, 24GB board) via OCuLink on Minisforum DG2 - Vulkan test for MTP
...
[Unit]
Description=llama.cpp AI Engine (llama-server) - Vulkan K80 dual GK210 on port 80 - test branch
