...
INVENTORY="${ANSIBLE_DIR}/inventories/hlh-ai-engine-vulkan.yml"
PLAYBOOK="${ANSIBLE_DIR}/playbooks/hlh-ai-engine-vulkan.yml"
...
usage() {
    cat <<'EOF'
Usage:
  ./configure-hlh-ai-engine-vulkan.sh [--host <ip>] [--offline]
