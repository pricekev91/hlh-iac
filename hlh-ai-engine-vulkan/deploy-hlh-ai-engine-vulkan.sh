...
This is the direct Proxmox bootstrap path (no OpenTofu):
	1) Create privileged LXC 120 (hlh-ai-engine-vulkan)
...
LXC_ID=120
LXC_NAME="hlh-ai-engine-vulkan"
LXC_HOSTNAME="hlh-ai-engine-vulkan"
...
confirm_existing_lxc_delete() {
	...
	printf '%s\n' 'Are you sure?  hlh-ai-engine-vulkan is already running and deployed!'
...
pct create "${LXC_ID}" "${LXC_IMAGE}" \
	...
	--description "llama.cpp AI engine with Vulkan, model storage on ${POOL} (Qwen3-Coder-30B)"
